function k = custom_menu(xHeader,varargin)
...
xPos = (winWide/2 - btnWide/2 - uiGap - 2*uiBorder)*ones(1,numRows); %(uiBorder + (0:numCols-1)'*( btnWide + uiGap )*ones(1,numRows) )';
xPos = xPos(1:numItems)+25; % [ all 1st col; all 2nd col; ...; all nth col ]
